...
@section('titles')
    <title>Keysoft NLA WMS - Add Employee</title>
@endsection
    ...
    <div class="px-lg-5 py-lg-3 p-3">
        <div class="d-flex flex-column flex-md-row justify-content-md-between align-items-md-center py-2 text-md-start">
            <div class="flex-grow-1 mb-1 mb-md-0">
                ...
                <form autocomplete="off" method="post" enctype="multipart/form-data" action="{{ route('user.employee.store') }}">
                    @csrf
                        ...
                        <div class="block-content pb-3">
                            ...
                            <div class="row align-items-center mb-3">
                                <div class="col-lg-2 col-12">
                                    ...
                                    <input type="text" name="EmployeeID" id="EmployeeID" class="form-control" value="{{ old('EmployeeID') ?? '' }}" required  {{ old('automatic') ? 'disabled' : (count($errors->all()) > 0 ? '' : 'disabled') }}>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-12 pe-lg-5">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="space-y-2">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="genderMale" name="Gender" value="M" {{ old('Gender') ? (old('Gender') == 'M' ? 'checked' : '') : '' }}>
                                                <label class="form-check-label" for="genderMale">Male</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="genderFemale" name="Gender" value="F" {{ old('Gender') ? (old('Gender') == 'F' ? 'checked' : '') : '' }}>
                                    ...
                                    <div class="mb-3" style="max-width: 200px;">
                                        ...
                                        <input type="text" class="js-flatpickr form-control js-flatpickr-enabled flatpickr-input active" id="BirthDate" name="BirthDate" placeholder="d/m/Y" value="{{ old('BirthDate') ?? '' }}" readonly="readonly">
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="space-y-2">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="BloodTypeA" name="BloodType" value="A" {{ old('BloodType') ? (old('BloodType') == 'A' ? 'checked' : '') : '' }}>
                                                <label class="form-check-label" for="BloodTypeA">A</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="BloodTypeB" name="BloodType" value="B" {{ old('BloodType') ? (old('BloodType') == 'B' ? 'checked' : '') : '' }}>
                                                <label class="form-check-label" for="BloodTypeB">B</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="BloodTypeAB" name="BloodType" value="AB" {{ old('BloodType') ? (old('BloodType') == 'AB' ? 'checked' : '') : '' }}>
                                                <label class="form-check-label" for="BloodTypeAB">AB</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="BloodTypeO" name="BloodType" value="O" {{ old('BloodType') ? (old('BloodType') == 'O' ? 'checked' : '') : '' }}>
                                ...
                                <div class="col-lg-6 col-12 ps-lg-5">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="IDNumber" value="{{ old('IDNumber') ?? '' }}" class="form-control">
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" name="MatrialStatus">
                                            <option value="SINGLE" {{ old('MatrialStatus') ? (old('MatrialStatus') == 'SINGLE' ? 'selected' : '') : '' }}>SINGLE</option>
                                            <option value="MARRIED" {{ old('MatrialStatus') ? (old('MatrialStatus') == 'MARRIED' ? 'selected' : '') : '' }}>MARRIED</option>
                                        </select>
                                    </div>
                                    <div class="mb-3">
                            ...
                            <div class="row mt-3">
                                <div class="col-lg-6 col-12 pe-lg-5">
                                    <div class="mb-3" style="max-width: 200px;">
                                        ...
                                        <input type="text" class="js-flatpickr form-control js-flatpickr-enabled flatpickr-input active" id="HireDate" name="HireDate" placeholder="d/m/Y" value="{{ old('HireDate') ?? '' }}" readonly="readonly">
                                    </div>
                                    <div class="mb-3" style="max-width: 200px;">
                                        <label class="form-label" for="ActiveDate">Active Date</label>
                                        <input type="text" class="js-flatpickr form-control js-flatpickr-enabled flatpickr-input active" id="ActiveDate" name="ActiveDate" placeholder="d/m/Y" value="{{ old('ActiveDate') ?? '' }}" readonly="readonly">
                                    </div>
                            ...
                            <div class="row mt-3">
                                <div class="col-lg-6 col-12">
                                    <div class="mb-3" style="max-width: 200px;">
                                        ...
                                        <input type="text" name="BankID" value="{{ old('BankID') ?? '' }}" class="form-control">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Bank Name</label>
                                        <input type="text" name="BankName" value="{{ old('BankName') ?? '' }}" class="form-control">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Bank Account No.</label>
                                        <input type="text" name="BankAccountNo" value="{{ old('BankAccountNo') ?? '' }}" class="form-control">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Bank Account Owner</label>
                                        <input type="text" name="BankAccountOwner" value="{{ old('BankAccountOwner') ?? '' }}" class="form-control">
                                    </div>
                                </div>
                            </div>
                        </div>
