...
@section('titles')
    <title>Keysoft NLA WMS - Edit Supplier</title>
@endsection
        ...
        <div class="d-flex flex-column flex-md-row justify-content-md-between align-items-md-center py-2 text-md-start">
            <div class="flex-grow-1 mb-1 mb-md-0">
                ...
                <form autocomplete="off" method="post" enctype="multipart/form-data"
                    action="{{ route('user.supplier.update') }}">
                    @csrf
                            ...
                            <div class="row align-items-center mb-3">
                                <div class="col-lg-2">
                                    ...
                                    <input type="text" name="SupplierID" id="SupplierID" class="form-control"
                                        value="{{ old('SupplierID') ?? $supplier->SupplierID }}" readonly>
                                </div>
                                <div class="col-auto px-lg-0">
                                    ...
                                    <div class="form-check ms-lg-4 pt-lg-2">
                                        <input class="form-check-input fs-6" type="checkbox" value="1" name="Active"
                                            id="Active"
                                            {{ old('Active') ? 'checked' : ($supplier->Active == 1 ? 'checked' : '') }}>
                                ...
                                <div class="col-lg-6 col-12 pe-lg-5">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="Website"
                                            value="{{ old('Website') ?? $supplier->Website }}" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-12 ps-lg-5">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="NPWP"
                                            value="{{ old('NPWP') ?? $supplier->NPWP }}" class="form-control">
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="d-flex flex-row align-items-center">
                                            <input type="text" name="LimitDaysETA"
                                                value="{{ old('LimitDaysETA') ?? $supplier->LimitDaysETA }}"
                                                class="form-control number-input" style="width: 100px;">
                                            <p class="mb-0 ms-2">Day(s)</p>
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <div class="d-flex flex-row align-items-center">
                                            <input type="text" name="LimitDaysETD"
                                                value="{{ old('LimitDaysETD') ?? $supplier->LimitDaysETD }}"
                                                class="form-control number-input" style="width: 100px;">
                                            <p class="mb-0 ms-2">Day(s)</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="AccountPayableLimit"
                                            value="{{ old('AccountPayableLimit') ?? $supplier->AccountPayableLimit }}"
                            ...
                            <div class="row mb-2">
                                <div class="col-lg-3 col-12">
                                    ...
                                    <input type="text" name="IndividualID" id="IndividualID" class="form-control"
                                        value="{{ old('IndividualID') ?? $supplier->IndividualID }}">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-lg-5 col-12">
                                    ...
                                    <input type="text" name="IndividualName" id="IndividualName" class="form-control"
                                        value="{{ old('IndividualName') ?? $supplier->IndividualName }}">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-lg-5 col-12">
                                    ...
                                    <input type="text" name="NPWPOwner" id="NPWPOwner" class="form-control"
                                        value="{{ old('NPWPOwner') ?? $supplier->NPWPOwner }}">
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="col-lg-6 col-12">
                                    <div class="mb-3" style="max-width: 200px;">
                                        ...
                                        <input type="text" name="BankID"
                                            value="{{ old('BankID') ?? $supplier->BankID }}" class="form-control">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Bank Name</label>
                                        <input type="text" name="BankName"
                                            value="{{ old('BankName') ?? $supplier->BankName }}" class="form-control">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Bank Account No.</label>
                                        <input type="text" name="BankAccountNo"
                                            value="{{ old('BankAccountNo') ?? $supplier->BankAccountNo }}"
                                            class="form-control">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Bank Account Owner</label>
                                        <input type="text" name="BankAccountOwner"
                                            value="{{ old('BankAccountOwner') ?? $supplier->BankAccountOwner }}"
                                            class="form-control">
                                    </div>
                                </div>
                            </div>
        ...
        $(function() {
            ...
            $.ajax({
                ...
                if (data.status == 'success') {
                    var options = '';
                    var oldID = '{{ old('CountryID') ?? $supplier->CountryID }}';
            ...
            $.ajax({
                ...
                if (data.status == 'success') {
                    var options = '';
                    var oldID = '{{ old('DivisionID') ?? $supplier->DivisionID }}';
                    for (var i = 0; i < data.data.length; i++) {
                        options +=
                            `<option value="${data.data[i].id}" ${ oldID == data.data[i].id ? 'selected' : '' }>${data.data[i].id}${data.data[i].text != null ? ' - ' + data.data[i].text : ''}</option>`;
                    }
