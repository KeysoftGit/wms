...
@section('titles')
    <title>Keysoft NLA WMS - Master Supplier</title>
@endsection
        ...
        <div class="d-flex flex-column flex-md-row justify-content-md-between align-items-md-center py-2 text-md-start">
            <div class="flex-grow-1 mb-1 mb-md-0">
                ...
                <div class="row justify-content-end mb-2">
                    @if (auth()->user()->hasAnyPermission(['admin', 'supplier.add']))
                        <div class="col-auto">
                            <a class="btn btn-primary" href="{{ route('user.supplier.add') }}"><i
    ...
    <script>
        $(function() {
            $('#datatable').DataTable({
                ...
                responsive: false,
                ajax: {
                    url: '{!! route('user.supplier.datatable') !!}'
                },
                        ...
                        $.ajax({
                            ...
                            if (data.status == 'success') {
                                ...
                                Swal.fire({
                                    icon: 'error',
                                    title: 'Failed',
                                    text: 'Delete failed! Make sure this supplier is not used in any other data!'
                                });
                            }
                        });
                    }
