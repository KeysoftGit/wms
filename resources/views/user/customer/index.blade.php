...
@section('titles')
    <title>Keysoft NLA WMS - Master Customer</title>
@endsection
            ...
            <div class="flex-grow-1 mb-1 mb-md-0">
                ...
                <div class="row justify-content-end mb-2">
                    @if (auth()->user()->hasAnyPermission(['admin', 'customer.view']))
                        <div class="col-auto">
                            <a class="btn btn-success" href="{{ route('user.customer.export') }}"><i
                                    class="fa fa-fw fa-file-excel"></i> Export All</a>
                        </div>
                    @endif
                    @if (auth()->user()->hasAnyPermission(['admin', 'customer.add']))
                        <div class="col-auto">
                            <a class="btn btn-primary" href="{{ route('user.customer.add') }}"><i
                        ...
                        $.ajax({
                            ...
                            if (data.status == 'success') {
                                ...
                                Swal.fire({
                                    icon: 'error',
                                    title: 'Failed',
                                    text: 'Delete failed! Make sure this customer is not used in any other data!'
                                });
                            }
                        });
                    }
