...
@section('titles')
    <title>Keysoft NLA WMS - Add Customer</title>
@endsection
    ...
    <div class="px-lg-5 py-lg-3 p-3">
        <div class="d-flex flex-column flex-md-row justify-content-md-between align-items-md-center py-2 text-md-start">
            <div class="flex-grow-1 mb-1 mb-md-0">
                ...
                <form autocomplete="off" method="post" enctype="multipart/form-data" action="{{ route('user.customer.store') }}">
                    @csrf
                        ...
                        <div class="block-content pb-3">
                            ...
                            <div class="row align-items-center mb-3">
                                <div class="col-lg-2 col-12">
                                    ...
                                    <input type="text" name="CustomerID" id="CustomerID" class="form-control" value="{{ old('CustomerID') ?? '' }}" required  {{ old('automatic') ? 'disabled' : (count($errors->all()) > 0 ? '' : 'disabled') }}>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-12 pe-lg-5">
                                    ...
                                    <div class="mb-3" style="max-width: 200px;">
                                        ...
                                        <input type="text" class="js-flatpickr form-control js-flatpickr-enabled flatpickr-input active" id="Birthday" name="Birthday" placeholder="d/m/Y" value="{{ old('Birthday') ?? '' }}" readonly="readonly">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-12 ps-lg-5">
                                    <div class="mb-3">
                                        ...
                                        <div class="d-flex flex-row align-items-center">
                                            <input type="text" name="Term" value="{{ old('Term') ?? '0' }}" class="form-control number-input" style="width: 100px;">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="d-flex flex-row align-items-center">
                                            <input type="text" name="LimitDaysETA" value="{{ old('LimitDaysETA') ?? '0' }}" class="form-control number-input" style="width: 100px;">
                                            <p class="mb-0 ms-2">Day(s)</p>
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <div class="d-flex flex-row align-items-center">
                                            <input type="text" name="LimitDaysETD" value="{{ old('LimitDaysETD') ?? '0' }}" class="form-control number-input" style="width: 100px;">
                                            <p class="mb-0 ms-2">Day(s)</p>
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-lg-3 col-12 mb-3 mb-lg-0">
                                                <input type="text" name="CreditLimit" value="{{ old('CreditLimit') ?? '0' }}" class="form-control number-input">
                                            </div>
                                            <div class="col-auto">
                                                <div class="form-check ms-lg-4">
                                                    <input class="form-check-input fs-6" type="checkbox" value="1" name="ChequeOutstandingRecognize" id="ChequeOutstandingRecognize" {{ old('ChequeOutstandingRecognize') ? 'checked' : '' }}>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="LockDueDateByDay" value="{{ old('LockDueDateByDay') ?? '1' }}" class="form-control number-input">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Invoice Outstanding Limit</label>
                                        <input type="text" name="InvoiceLimit" value="{{ old('InvoiceLimit') ?? '0' }}" class="form-control number-input">
                                    </div>
                        ...
                        <div class="block-content">
                            ...
                            <div class="row mb-2">
                                <div class="col-lg-3 col-12">
                                    ...
                                    <input type="text" name="IndividualID" id="IndividualID" class="form-control" value="{{ old('IndividualID') ?? '' }}">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-lg-5 col-12">
                                    <label class="form-label">Individual Name</label>
                                    <input type="text" name="IndividualName" id="IndividualName" class="form-control" value="{{ old('IndividualName') ?? '' }}">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-lg-5 col-12">
                                    <label class="form-label">NPWP Owner</label>
                                    <input type="text" name="NPWPOwner" id="NPWPOwner" class="form-control" value="{{ old('NPWPOwner') ?? '' }}">
                                </div>
                            </div>
                        </div>
                    </div>
