...
@section('titles')
    <title>Keyonline - Add User</title>
@endsection
    ...
    <div class="px-lg-5 py-lg-3 p-3" id="vue-container">
        <div class="d-flex flex-column flex-md-row justify-content-md-between align-items-md-center py-2 text-md-start">
            <div class="flex-grow-1 mb-1 mb-md-0">
                ...
                <form autocomplete="off" method="post" enctype="multipart/form-data" action="{{ route('user.store') }}">
                    @csrf
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-12">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-7 col-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="UserNameParam" value="{{ old('UserNameParam') ?? '' }}" class="form-control" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="password" name="PasswordParam" value="" class="form-control" required>
                                    </div>
