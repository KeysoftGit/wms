        ...
        <div class="d-flex flex-column flex-md-row justify-content-md-between align-items-md-center py-2 text-md-start">
            <div class="flex-grow-1 mb-1 mb-md-0">
                ...
                <div class="row justify-content-end mb-2">
                    <div class="col-auto">
                        <a class="btn btn-primary" href="{{ route('user.add') }}"><i class="fa fa-fw fa-plus"></i> Add</a>
                    </div>
                </div>
    ...
    <script>
        $(function() {
            $('#datatable').DataTable({
                ...
                order: [ [3, 'desc'] ],
                columns: [
                    { data: 'UserID', name: 'UserID', class: 'text-center'},
            ...
            $('#datatable').on('click', '.enable-btn', function () {
                let el  = $(this);
