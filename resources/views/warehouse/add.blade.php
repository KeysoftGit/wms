...
@section('titles')
    <title>Keysoft NLA WMS - Add Warehouse</title>
@endsection
    ...
    <div class="px-lg-5 py-lg-3 p-3">
        <div class="d-flex flex-column flex-md-row justify-content-md-between align-items-md-center py-2 text-md-start">
            <div class="flex-grow-1 mb-1 mb-md-0">
                ...
                <form autocomplete="off" method="post" enctype="multipart/form-data" action="{{ route('warehouse.store') }}">
                    @csrf
                            ...
                            <div class="row align-items-center mb-3">
                                <div class="col-lg-2 col-auto">
                                    ...
                                    <input type="text" name="WarehouseID" id="WarehouseID" class="form-control"
                                        value="{{ old('WarehouseID') ?? '' }}" required
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-12 pe-lg-5">
                                    ...
                                    @if ($showDivisions)
                                        ...
                                        <select class="form-select form-select2" name="DivisionID"
                                            id="DivisionID">
