...
@section('titles')
    <title>Keysoft NLA WMS - Inventory Unit</title>
@endsection
        ...
        <div class="d-flex flex-column flex-md-row justify-content-md-between align-items-md-center py-2 text-md-start">
            <div class="flex-grow-1 mb-1 mb-md-0">
                ...
                <div class="row justify-content-end mb-2">
                    @if(auth()->user()->hasAnyPermission(['admin', 'unit.add']))
                        <div class="col-auto">
                            <a class="btn btn-primary" href="{{ route('inventory.unit.add') }}"><i class="fa fa-fw fa-plus"></i> Add</a>
                        </div>
                    @endif
                </div>
    ...
    <script>
        $(function() {
            $('#datatable').DataTable({
                ...
                responsive: false,
                ajax: {
                    url: '{!! route('inventory.unit.datatable') !!}'
                },
                ...
                order: [ [3, 'desc'] ],
                columns: [
                    { data: 'UnitID', name: 'UnitID', class: 'text-center'},
                    { data: 'UnitName', name: 'UnitName', class: 'text-center'},
                        ...
                        $.ajax({
                            ...
                            if (data.status == 'success'){
                                ...
                                Swal.fire({
                                    icon: 'error',
                                    title: 'Failed',
                                    text: 'Delete failed! Make sure this unit is not used in any other data!'
                                });
                            }
                        });
                    }
