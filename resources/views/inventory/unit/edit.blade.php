...
@section('titles')
    <title>Keysoft NLA WMS - Edit Inventory Unit</title>
@endsection
    ...
    <div class="px-lg-5 py-lg-3 p-3">
        <div class="d-flex flex-column flex-md-row justify-content-md-between align-items-md-center py-2 text-md-start">
            <div class="flex-grow-1 mb-1 mb-md-0">
                ...
                <form autocomplete="off" method="post" enctype="multipart/form-data" action="{{ route('inventory.unit.update') }}">
                    @csrf
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="UnitID" class="form-control" value="{{ old('UnitID') ?? $unit->UnitID }}" readonly>
                                    </div>
                                </div>
                                <div class="col-lg-5 col-12">
                                    <div class="mb-3">
                                        <label class="form-label">Unit Name</label>
                                        <input type="text" name="UnitName" value="{{ old('UnitName') ?? $unit->UnitName }}"class="form-control">
                                    </div>
                                </div>
                            </div>
