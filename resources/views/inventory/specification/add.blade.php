...
@section('titles')
    <title>Keysoft NLA WMS - Add Inventory Specification</title>
@endsection
        ...
        <div class="d-flex flex-column flex-md-row justify-content-md-between align-items-md-center py-2 text-md-start">
            <div class="flex-grow-1 mb-1 mb-md-0">
                ...
                <form autocomplete="off" method="post" enctype="multipart/form-data"
                    action="{{ route('inventory.specification.store') }}">
                    @csrf
                                ...
                                <div class="col-lg-3 col-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="SpecificationID" class="form-control"
                                            value="{{ old('SpecificationID') ?? '' }}" required>
                                    </div>
                                </div>
                                <div class="col-lg-5 col-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="SpecificationName"
                                            value="{{ old('SpecificationName') ?? '' }}"class="form-control">
                                    </div>
                                </div>
                                    ...
                                    <div class="col-auto px-lg-0">
                                        ...
                                        <div class="form-check ms-4 pt-lg-2">
                                            <input class="form-check-input fs-6" type="checkbox" value="1"
                                                ...
                                                {{ old('asBatch') ? 'checked' : (count($errors->all()) > 0 ? '' : 'checked') }}>
