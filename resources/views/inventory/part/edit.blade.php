    ...
    <div class="px-lg-5 py-lg-3 p-3">
        <div class="d-flex flex-column flex-md-row justify-content-md-between align-items-md-center py-2 text-md-start">
            <div class="flex-grow-1 mb-1 mb-md-0">
                ...
                <form autocomplete="off" method="post" enctype="multipart/form-data" action="{{ route('inventory.part.update') }}">
                    @csrf
                        ...
                        <div class="block-content pb-3">
                            ...
                            <div class="row align-items-center mb-3">
                                <div class="col-lg-2 col-12">
                                    ...
                                    <input type="text" name="PartID" id="PartID" class="form-control" value="{{ old('PartID') ?? $part->PartID }}" required readonly>
                                </div>
                                <div class="col-auto px-lg-0">
                                    <label class="form-label"></label>
                                    <div class="form-check ms-lg-4 pt-lg-2">
                                        <input class="form-check-input fs-6" type="checkbox" value="1" name="Active" id="Active" {{ old('Active') ? 'checked' : ($part->Active == 1 ? 'checked' : '') }}>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-12 pe-lg-5">
                                    ...
                                    <div class="mb-3" id="loading-specification">
                                        <label class="form-label">Specification <span class="text-danger">*</span></label>
                                        <select class="form-select" disabled>
                                            <option id="loading-text">Loading Specifications.....</option>
                                        </select>
                                    </div>
                                    <div class="mb-3" id="specification-container">
                                        <label class="form-label">Specification <span class="text-danger">*</span></label>
                                        <select class="form-select form-select2" name="SpecificationID" id="SpecificationID" required>
                                            <option value="">-</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="mb-3" id="type-container">
                                        <label class="form-label">Inventory Type <span class="text-danger">*</span></label>
                                        <select class="form-select form-select2" name="InventoryTypeID" id="InventoryTypeID" required>
                                            <option value="">-</option>
                                        </select>
                                    </div>
                                            ...
                                            <div class="col">
                                                <div class="space-x-2">
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" id="PartTypeS" name="PartType" value="S" {{ old('PartType') ? (old('PartType') == 'S' ? 'checked' : '') : ($part->PartType == 'S' ? 'checked' : '') }}>
                                                        <label class="form-check-label" for="PartTypeS">Stock</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" id="PartTypeN" name="PartType" value="N" {{ old('PartType') ? (old('PartType') == 'N' ? 'checked' : '') : ($part->PartType == 'N' ? 'checked' : '') }}>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="MinimumStockBuffer" value="{{ old('MinimumStockBuffer') ?? $part->MinimumStockBuffer }}" class="form-control number-input">
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="mb-3">
                                                <label class="form-label">Maximum Stock Buffer</label>
                                                <input type="text" name="MaximumStockBuffer" value="{{ old('MaximumStockBuffer') ?? $part->MaximumStockBuffer }}" class="form-control number-input">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="d-flex flex-row align-items-center">
                                            <input type="text" name="VAT2" value="{{ old('VAT2') ?? $part->VAT2 }}" class="form-control number-input" style="width: 100px">
                                ...
                                <div class="col-lg-6 col-12 ps-lg-5">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="PartName" value="{{ old('PartName') ?? $part->PartName }}" class="form-control" required>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Coil No</label>
                                        <input type="text" name="OtherID" value="{{ old('OtherID') ?? $part->OtherID }}" class="form-control">
                                    </div>
                                    ...
                                    <div class="mb-3" id="warehouse-container">
                                        <label class="form-label">Deffered Warehouse</label>
                                        <select class="form-select form-select2" name="DeferedWarehouseID" id="DeferedWarehouseID" required>
                                            <option value="">-</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <div class="unit-container">
                                                ...
                                                <select class="form-select unit" data-sequence="1" name="Unit[]" id="Unit1">
                                                    <option value="">-</option>
                                                </select>
                                            </div>
                                        </div>
                                ...
                                <div class="border border-light rounded p-3">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <div class="unit-container">
                                                <label class="form-label" for="Unit1">Unit ID</label>
                                                <select class="form-select unit" data-sequence="2" name="Unit[]" id="Unit2" :disabled="!picked1">
                                                    <option value="">-</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-auto">
                                            ...
                                            <div class="d-flex flex-row align-items-center space-x-3">
                                                <p class="m-0 fs-6">=</p>
                                                <input class="form-control unit1" v-model="unit1" readonly style="width: 25vw;">
                                                <p class="m-0 fs-6 ps-3">x</p>
                                                <input class="form-control number-input" name="Conversion[]" style="width: 25vw;" value="{{ old('Conversion.0') ?? (count($part->units) > 1 ? $part->units[1]->Conversion : '') }}" :disabled="!picked1">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="border border-light rounded p-3">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <div class="unit-container">
                                                <label class="form-label" for="Unit1">Unit ID</label>
                                                <select class="form-select unit" data-sequence="3" name="Unit[]" id="Unit3" :disabled="!picked2">
                                                    <option value="">-</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-auto">
                                            ...
                                            <div class="d-flex flex-row align-items-center space-x-3">
                                                ...
                                                <input class="form-control unit1" v-model="unit1" readonly style="width: 25vw;">
                                                <p class="m-0 fs-6 ps-3">x</p>
                                                <input class="form-control number-input" name="Conversion[]" value="{{ old('Conversion.1') ?? (count($part->units) > 2 ? $part->units[2]->Conversion : '') }}" style="width: 25vw;" :disabled="!picked2">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="border border-light rounded p-3">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <div class="unit-container">
                                                <label class="form-label" for="Unit1">Unit ID</label>
                                                <select class="form-select unit" data-sequence="4" name="Unit[]" id="Unit4" :disabled="!picked3">
                                                    <option value="">-</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-auto">
                                            ...
                                            <div class="d-flex flex-row align-items-center space-x-3">
                                                ...
                                                <input class="form-control unit1" v-model="unit1" readonly style="width: 25vw;">
                                                <p class="m-0 fs-6 ps-3">x</p>
                                                <input class="form-control number-input" name="Conversion[]" value="{{ old('Conversion.2') ?? (count($part->units) > 3 ? $part->units[3]->Conversion : '') }}" style="width: 25vw;" :disabled="!picked3">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="border border-light rounded p-3">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <div class="unit-container">
                                                <label class="form-label" for="Unit1">Unit ID</label>
                                                <select class="form-select unit" data-sequence="5" name="Unit[]" id="Unit5" :disabled="!picked4">
                                                    <option value="">-</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-auto">
                                            ...
                                            <div class="d-flex flex-row align-items-center space-x-3">
                                                ...
                                                <input class="form-control unit1" v-model="unit1" readonly style="width: 25vw;">
                                                <p class="m-0 fs-6 ps-3">x</p>
                                                <input class="form-control number-input" name="Conversion[]" value="{{ old('Conversion.3') ?? (count($part->units) > 4 ? $part->units[4]->Conversion : '') }}" style="width: 25vw;" :disabled="!picked4">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="block-content">
                            <div class="mb-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-auto">
                                        @if($part->Image2 != null)
                                            <a href="{{ asset('storage/part/'. $part->Image2) }}" title="See Original" class="btn btn-alt-secondary" target="_blank"><i class="fa fa-fw fa-eye"></i></a>
                                        @else
                                            ...
                                            <div class="col">
                                                <div class="space-y-2">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" id="Price1" name="Pricing" value="BasedOnPrice" {{ old('Pricing') ? (old('Pricing') == 'BasedOnPrice' ? 'checked' : '') : ($part->Pricing == 'BasedOnPrice' ? 'checked' : '') }}>
                                                        <label class="form-check-label" for="Price1">Based On Price</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" id="Price2" name="Pricing" value="BasedOnDiscBarometer" {{ old('Pricing') ? (old('Pricing') == 'BasedOnDiscBarometer' ? 'checked' : '') : ($part->Pricing == 'BasedOnDiscBarometer' ? 'checked' : '') }}>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="space-y-2">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" id="G1" name="TypeOfGuarantee" value="GUARANTEE_PART" {{ old('TypeOfGuarantee') ? (old('TypeOfGuarantee') == 'GUARANTEE_PART' ? 'checked' : '') : ($part->TypeOfGuarantee == 'GUARANTEE_PART' ? 'checked' : '') }}>
                                                        <label class="form-check-label" for="G1">Part Guarantee</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" id="G2" name="TypeOfGuarantee" value="GUARANTEE_SERVICE" {{ old('TypeOfGuarantee') ? (old('TypeOfGuarantee') == 'GUARANTEE_SERVICE' ? 'checked' : '') : ($part->TypeOfGuarantee == 'GUARANTEE_SERVICE' ? 'checked' : '') }}>
                                                        <label class="form-check-label" for="G2">Service Guarantee</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" id="G3" name="TypeOfGuarantee" value="GUARANTEE_PART_SERVICE" {{ old('TypeOfGuarantee') ? (old('TypeOfGuarantee') == 'GUARANTEE_PART_SERVICE' ? 'checked' : '') : ($part->TypeOfGuarantee == 'GUARANTEE_PART_SERVICE' ? 'checked' : '') }}>
                                                        <label class="form-check-label" for="G3">Service And Part Guarantee</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" id="G4" name="TypeOfGuarantee" value="NON_GUARANTEE" {{ old('TypeOfGuarantee') ? (old('TypeOfGuarantee') == 'NON_GUARANTEE' ? 'checked' : '') : ($part->TypeOfGuarantee == 'NON_GUARANTEE' ? 'checked' : '') }}>
                ...
                methods: {
                    ...
                    loadUnit(){
                        ...
                        $.ajax({
                            ...
                            if (data.status == 'success'){
                                var opt1 = '';
                                var oldID = '{{ old("Unit.0") ?? (count($part->units) > 0 ? $part->units[0]->UnitID1 : '') }}';
                                console.log(oldID);
                                for(var i = 0; i < data.data.length; i++){
                                    if(oldID == data.data[i].id){
                                        el.unit1 = `${data.data[i].id}${data.data[i].text != null ? ' - ' + data.data[i].text : ''}`;
                                    }
                                    opt1 += `<option value="${data.data[i].id}" ${ oldID == data.data[i].id ? 'selected' : '' }>${data.data[i].id}${data.data[i].text != null ? ' - ' + data.data[i].text : ''}</option>`;
                                }
                                if(oldID != ''){
                                    el.picked1 = true;
                                }
                                ...
                                var opt2 = '';
                                oldID = '{{ old("Unit.1") ?? (count($part->units) > 1 ? $part->units[1]->UnitID2 : '') }}';
                                for(var i = 0; i < data.data.length; i++){
                                    opt2 += `<option value="${data.data[i].id}" ${ oldID == data.data[i].id ? 'selected' : '' }>${data.data[i].id}${data.data[i].text != null ? ' - ' + data.data[i].text : ''}</option>`;
                                }
                                if(oldID != ''){
                                    el.picked2 = true;
                                }
                                ...
                                var opt3 = '';
                                oldID = '{{ old("Unit.2") ?? (count($part->units) > 2 ? $part->units[2]->UnitID2 : '') }}';
                                for(var i = 0; i < data.data.length; i++){
                                    opt3 += `<option value="${data.data[i].id}" ${ oldID == data.data[i].id ? 'selected' : '' }>${data.data[i].id}${data.data[i].text != null ? ' - ' + data.data[i].text : ''}</option>`;
                                }
                                if(oldID != ''){
                                    el.picked3 = true;
                                }
                                ...
                                var opt4 = '';
                                oldID = '{{ old("Unit.3") ?? (count($part->units) > 3 ? $part->units[3]->UnitID2 : '') }}';
                                for(var i = 0; i < data.data.length; i++){
                                    opt4 += `<option value="${data.data[i].id}" ${ oldID == data.data[i].id ? 'selected' : '' }>${data.data[i].id}${data.data[i].text != null ? ' - ' + data.data[i].text : ''}</option>`;
                                }
                                if(oldID != ''){
                                    el.picked4 = true;
                                }
                                ...
                                var opt5 = '';
                                oldID = '{{ old("Unit.4") ?? (count($part->units) > 4 ? $part->units[4]->UnitID2 : '') }}';
                                for(var i = 0; i < data.data.length; i++){
                                    opt5 += `<option value="${data.data[i].id}" ${ oldID == data.data[i].id ? 'selected' : '' }>${data.data[i].id}${data.data[i].text != null ? ' - ' + data.data[i].text : ''}</option>`;
                                }
                                $('#Unit5').append(opt5);
