...
@section('titles')
    <title>Keyonline - Edit Item Transfer</title>
@endsection
...
@section('content')
    ...
    <div class="px-lg-5 py-lg-3 p-3" id="vue-container">
        <form autocomplete="off" method="post" enctype="multipart/form-data" action="{{ route('transfer.update') }}" id="transfer-form">
            @csrf
            ...
            <input type="hidden" name="id" value="{{ $transfer->TransactionNo }}">
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="row align-items-center mb-3">
                                <div class="col-lg-3 col-12 mb-lg-0 mb-3">
                                    ...
                                    <input type="text" name="TransactionNo" id="TransactionNo" class="form-control" value="{{ old('TransactionNo') ?? $transfer->TransactionNo }}" readonly>
                                </div>
                                <div class="col-lg-3 col-12">
                                    <label class="form-label">Transaction Date <span class="text-danger">*</span></label>
                                    <input type="text" class="js-flatpickr form-control js-flatpickr-enabled flatpickr-input active" id="TransactionDate" name="TransactionDate" placeholder="d/m/Y" value="{{ old('TransactionDate') ?? date('d/m/Y', strtotime($transfer->TransactionDate)) }}" required readonly>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        let app = new Vue({
            ...
            data: {
                ...
                fromId: '{{ old('WarehouseIDFrom') ?? $transfer->WarehouseIDFrom }}',
                staffFrom: '{{ old('StaffInChargeIDFrom') ?? $transfer->StaffInChargeIDFrom }}',
                toId: '{{ old('WarehouseIDTo') ?? $transfer->WarehouseIDTo }}',
                staffTo: '{{ old('StaffInChargeIDTo') ?? $transfer->StaffInChargeIDTo }}',
            ...
            methods: {
                ...
                setModalPartName() {
                    ...
                    this.detailModal.partName = selectedText;
                },
                trimDecimal(value) {
