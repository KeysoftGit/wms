...
@section('titles')
    <title>Keysoft NLA WMS - Item Transfer</title>
@endsection
        ...
        <div class="d-flex flex-column flex-md-row justify-content-md-between align-items-md-center py-2 text-md-start">
            <div class="flex-grow-1 mb-1 mb-md-0">
                ...
                <div class="row justify-content-between align-items-end mb-3">
                    ...
                    @if(auth()->user()->hasAnyPermission(['admin', 'transfer.add']))
                        <div class="col-auto">
                            <a class="btn btn-primary" href="{{ route('transfer.add') }}"><i class="fa fa-fw fa-plus"></i> Add</a>
                        </div>
                    @endif
                </div>
        ...
        $(function() {
            ...
            $('#datatable').DataTable({
                ...
                columns: [
                    ...
                    { data: 'WarehouseIDFrom', name: 'WarehouseIDFrom', class: 'text-center'},
                    { data: 'WarehouseIDTo', name: 'WarehouseIDTo', class: 'text-center'},
            ...
            $('#datatable').on('click', '.delete-btn', function () {
                ...
                Swal.fire({
                    ...
                    text: "Are you sure you want to delete this item transfer?",
                    showDenyButton: true,
                        ...
                        $.ajax({
                            ...
                            if (data.status == 'success'){
                                ...
                                Swal.fire({
                                    icon: 'error',
                                    title: 'Failed',
                                    text: 'Delete failed! Make sure this invoice is not used in any other data!'
                                });
                            }
                        });
                    }
