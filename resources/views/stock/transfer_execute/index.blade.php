...
@section('titles')
    <title>Keysoft NLA WMS - Item Transfer Execute</title>
@endsection
        ...
        <div class="d-flex flex-column flex-md-row justify-content-md-between align-items-md-center py-2 text-md-start">
            <div class="flex-grow-1 mb-1 mb-md-0">
                ...
                <div class="row justify-content-between align-items-end mb-3">
                    ...
                    @if(auth()->user()->hasAnyPermission(['admin', 'transfer_execute.add']))
                        <div class="col-auto">
                            <a class="btn btn-primary" href="{{ route('transfer_execute.add') }}"><i class="fa fa-fw fa-plus"></i> Add</a>
                        </div>
                    @endif
                </div>
    ...
    <script>
        $(function() {
            ...
            $('#datatable').DataTable({
                ...
                responsive: false,
                ajax: {
                    url: '{!! route('transfer_execute.datatable') !!}',
                    data: {
                ...
                columns: [
                    ...
                    { data: 'RequestNo', name: 'RequestNo', class: 'text-center'},
                    { data: 'StaffInChargeFrom', name: 'StaffInChargeFrom', class: 'text-center'},
            ...
            $('#datatable').on('click', '.delete-btn', function () {
                ...
                Swal.fire({
                    icon: 'info',
                    title: 'Delete Item Transfer Execute',
                    text: "Are you sure you want to delete this item transfer execute?",
                    showDenyButton: true,
