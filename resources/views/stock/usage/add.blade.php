...
@section('titles')
    <title>Keysoft NLA WMS - Add Advanced Part Usage</title>
@endsection

@section('content')
    @php
        $title = 'Add Part Usage';
        $formAction = route('usage.store');
...
@section('scripts')
    ...
    <script>
        ...
        let app = new Vue({
            ...
            mounted() {
                FormPreserver.initVue(this, 'stock_usage_advanced_add', ['modalDetail', 'autonumericFormat2']);
