...
@section('content')
    <div class="px-lg-5 py-lg-4 p-3 bg-light rounded-3 shadow-sm">
        ...
        <div class="row mb-3">
            @if (auth()->user()->hasAnyPermission(['admin', 'part_usage.add']))
                <div class="col-auto ms-auto">
                    <a class="btn btn-primary" href="{{ route('usage.add') }}">
    ...
    <script>
        ...
        $('#datatable').on('click', '.delete-btn', function() {
            ...
            Swal.fire({
                ...
                text: 'Are you sure you want to delete this part usage?',
                showDenyButton: true,
