...
@section('titles')
    <title>Keysoft NLA WMS - Purchase Return Execute</title>
@endsection
    ...
    <script>
        $(function() {
            $('#datatable').DataTable({
                ...
                responsive: false,
                ajax: {
                    url: '{!! route('pr_execute.datatable') !!}',
                    data: {
                ...
                columns: [
                    ...
                    { data: 'GrandTotal', name: 'GrandTotal', class: 'text-center', render: $.fn.dataTable.render.number(',', '.', 0)},
