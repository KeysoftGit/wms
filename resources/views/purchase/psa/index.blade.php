...
@section('titles')
    <title>Keysoft NLA WMS - Purchase Settle Approval</title>
@endsection
                    ...
                    <div class="col-lg-auto col-12 mb-lg-0 mb-3">
                        <form autocomplete="off" id="filter-form">
                            <div class="d-flex flex-row align-items-end">
                                ...
                                <button type="submit" class="btn btn-secondary ms-3" id="filter"><i
                                        class="fa fa-fw fa-filter"></i>Filter</button>
                            </div>
                        </form>
                    </div>
                    @if (auth()->user()->hasAnyPermission(['admin', 'psa.add']) && $currentUserApprovalDT)
                        <div class="col-lg-auto col-12">
                            <a class="btn btn-primary" href="{{ route('psa.prs_selection') }}"><i
    ...
    <script>
        $(function() {
            ...
            $('#datatable').on('click', '.delete-btn', function() {
                ...
                Swal.fire({
                    icon: 'info',
                    title: 'Delete Purchase Request Settle',
                    text: "Are you sure you want to delete this purchase request settle?",
                    showDenyButton: true,
                        ...
                        $.ajax({
                            ...
                            if (data.status == 'success') {
                                ...
                                One.helpers('jq-notify', {
                                    ...
                                    message: 'Purchase request settle successfully deleted!',
                                });
                            } else {
                                Swal.fire({
                                    icon: 'error',
                                    title: 'Failed',
                                    text: 'Delete failed! Make sure this request is not used in any other data!'
                                });
                            }
                        });
                    }
