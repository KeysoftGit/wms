...
@section('titles')
    <title>Keysoft NLA WMS - Add Purchase Settle Approval</title>
@endsection
...
@section('content')
    ...
    <div class="px-lg-5 py-lg-3 p-3" id="vue-container">
        ...
        <div class="d-flex flex-row align-items-center mb-5">
            <a href="{{ route('psa.prs_selection') }}" class="h3 text-dark m-0"><i class="fa fa-fw fa-arrow-left"></i></a>
            <h1 class="h3 fw-bold ms-4 mb-0"> Add Purchase Settle Approval</h1>
        </div>
        ...
        <div class="row justify-content-between mb-3 align-items-end">
            <div class="col-auto d-flex flex-row">
                @if ($prs->Closed == 0)
                    @if (
                        !request()->has('br') &&
                            auth()->user()->hasAnyPermission(['admin', 'psa.add']))
                        <button class="btn btn-success ms-2 fs-6" id="approveBtn" @click="showApproveModal"><i
                                class="fa fa-fw fa-thumbs-up"></i>
                            Approve</button>
                    @endif
                    @if (
                        !request()->has('br') &&
                            auth()->user()->hasAnyPermission(['admin', 'psa.add']))
                        <button class="btn btn-danger ms-2 fs-6" id="rejectBtn" @click="showRejectModal"><i
                                class="fa fa-fw fa-thumbs-down"></i>
                            Reject</button>
                    @endif
                @endif
            </div>
            ...
            <div class="block-content p-4">
                <div class="row">
                    <div class="col-lg-6 col-12 pe-lg-5">
                        <div class="mb-3">
                            <label class="form-label">Settle Transaction No</label>
                    ...
                    <div class="col-lg-6 col-12 ps-lg-5">
                        <div class="col-6 mb-3" style="width: 100px">
                            ...
                            <input type="text" class="form-control" value="{{ $prs->Closed == 1 ? 'Closed' : 'Open' }}"
                                readonly>
                        </div>
        ...
        @include('purchase.psa.approve_modal')
        @include('purchase.psa.reject_modal')
        @include('purchase.psa.closing_reason_detail_modal')
    </div>
    <!-- END Hero -->
