...
@section('titles')
    <title>Keysoft NLA WMS - Goods Receiving</title>
@endsection
        ...
        <div class="d-flex flex-column flex-md-row justify-content-md-between align-items-md-center py-2 text-md-start">
            <div class="flex-grow-1 mb-1 mb-md-0">
                ...
                <div class="row justify-content-between align-items-end mb-3">
                    ...
                    @if(auth()->user()->hasAnyPermission(['admin', 'gr.add']))
                        <div class="col-auto">
                            <a class="btn btn-primary" href="{{ route('gr.add') }}"><i class="fa fa-fw fa-plus"></i> Add</a>
                        </div>
                    @endif
                </div>
        ...
        $(function() {
            ...
            $('#datatable').on('click', '.delete-btn', function () {
                ...
                Swal.fire({
                    ...
                    text: "Are you sure you want to delete this goods receiving?",
                    showDenyButton: true,
                        ...
                        $.ajax({
                            ...
                            if (data.status == 'success'){
                                ...
                                One.helpers('jq-notify', {
                                    ...
                                    message: 'Goods receiving successfully deleted!',
                                });
                            }
                            else {
                                Swal.fire({
