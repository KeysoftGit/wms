...
@section('content')
    ...
    <div class="px-lg-5 py-lg-3 p-3" id="vue-container">
        <form autocomplete="off" method="post" enctype="multipart/form-data" action="{{ route('gr.store') }}" id="po-form">
            @csrf
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-12 pe-lg-5">
                            ...
                            <div class="mb-3" id="po-container">
                                ...
                                <select2 url="{{ route('gr.po') }}"
                                    :extra="{ warehouse_id: warehouseID, require_warehouse: true }"
                                    v-model="sourceNumber" :prevalue="sourceNumber"
                                    class="form-select" name="PONumber" id="PONumber" placeholder="Pick PO" required>
                                    <option>-</option>
                                </select2>
                            </div>
                        </div>
                    ...
                    <div class="d-flex flex-row justify-content-between align-items-center mb-3">
                        ...
                        <div class="d-flex flex-row">
                            <button type="button" class="btn btn-primary ms-1" @click="openDetailModal"
                                ...
                                Part</button>
                            <button type="button" class="btn btn-secondary ms-1" @click="addRev"
                                :disabled="details.length == 0"><i class="fa fa-fw fa-plus me-1"></i>Add Rev</button>
                            <button type="button" class="btn btn-secondary ms-1" @click="removeRev"
                        ...
                        <table class="table table-bordered w-100" style="table-layout: fixed; overflow-x: scroll">
                            <thead>
                                <tr>
                                    ...
                                    <th v-for="rev in visibleRevFields" style="width: 250px;">
                                        <span
                            ...
                            <tbody>
                                <tr v-if="details.length == 0">
                                    <td :colspan="8 + visibleRevFields.length" class="text-center text-muted py-4">
                                ...
                                <tr v-for="(detail, index) in details">
                                    ...
                                    <td v-for="rev in visibleRevFields">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row" v-if="selectedPoDetail">
                            ...
                            <div class="col-lg-6 col-12 mb-3" v-for="rev in visibleRevFields">
...
@section('scripts')
    ...
    <script>
        let app = new Vue({
            ...
            mounted() {
                let app = this;
                FormPreserver.initVue(app, 'purchase_gr_advanced_add', ['autonumericFormat', 'autonumericFormat2']);
