...
@section('titles')
    <title>Keysoft NLA WMS - Add Purchase Order</title>
@endsection
...
@section('content')
    ...
    <div class=" w-100 px-lg-5 py-lg-3 p-3" id="vue-container" style="overflow-x: hidden">
        ...
        <form autocomplete="off" method="post" enctype="multipart/form-data" action="{{ route('po.store_from_settle') }}"
            id="po-form">
            @csrf

            <div class="d-flex flex-row align-items-center mb-5">
                <a href="{{ route('po') }}" class="h3 text-dark m-0"><i class="fa fa-fw fa-arrow-left"></i></a>
                        ...
                        <div class="col-lg-6 col-12 pe-lg-5">
                            <div class="row mb-3">
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="text"
                                        class="js-flatpickr form-control js-flatpickr-enabled flatpickr-input active"
                                        id="DueDate" name="DueDate" placeholder="d/m/Y" value="{{ old('DueDate') ?? '' }}"
                            ...
                            <div class="mb-3" id="division-container">
                                <label class="form-label">Division <span class="text-danger">*</span></label>
                                <select class="form-select form-select2" name="DivisionID" id="DivisionID" required>
                                    <option value="">-</option>
                                </select>
                            </div>
                            ...
                            <div class="mb-3" id="supplier-container">
                                <label class="form-label">Supplier <span class="text-danger">*</span></label>
                                <select class="form-select form-select2" name="SupplierID" id="SupplierID"
                                    v-model="supplierId" :disabled="supplierLocked" required>
                                    <option value="">-</option>
                                    <!-- isi options-nya sesuai data -->
                                </select>

                                <!-- Hidden input untuk tetap submit data meski select-nya di-disabled -->
                        ...
                        <div class="col-lg-6 col-12 ps-lg-5">
                            ...
                            <div class="mb-3" id="currency-container">
                                ...
                                <select2 url="{{ route('misc.currency', ['select2' => true]) }}" v-model="currency"
                                    :prevalue="currency" class="form-select" name="CurrencyID" id="CurrencyID"
                                    placeholder="Pick Currency" required>
                                    <option>-</option>
                                </select2>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="text" class="form-control number-input" name="Term"
                                        id="Term" value="{{ old('Term') ?? 0 }}">
                                </div>
                            </div>
                ...
                <div class="block-content">
                    <div class="d-flex flex-row justify-content-between align-items-center mb-3">
                        ...
                        <div class="d-flex flex-row">
                            <button type="button" class="btn btn-warning" @click="showSearchModal"
                                id="showSearchModalBtn" disabled>
                                <i class="fa fa-fw fa-search me-1"></i>
                                Search Purchase Request Settle
                            </button>
                        ...
                        <table class="table table-bordered nowrap w-100" style="table-layout: fixed; overflow-x: scroll">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width: 300px;">Settle No</th>
                                    <th style="width: 300px;">Part</th>
                                    <th style="width: 200px;">Qty</th>
                                    <th style="width: 200px;">Qty Remaining</th>
                            ...
                            <tbody>
                                ...
                                <tr v-for="(detail, index) in details" :key="detail.id">
                                    ...
                                    <td>
                                        <input class="form-control" v-model="detail.settleNo" name= "settleNo[]"
                                            readonly>
                                    </td>
                                    <td hidden>
                                        <input class="form-control" v-model="detail.settleDtID" name= "settleDtID[]"
                                            readonly>
                                    </td>
                                    <td hidden>
                                    ...
                                    <td>
                                        <input class="form-control" v-model="detail.part_name" name= "part_name[]"
                                            readonly>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <vue-autonumeric :options="autonumericFormat2" name="qtyRemaining[]"
                                            class="form-control" v-model="detail.qtyRemaining"
                                            :prevalue="detail.qtyRemaining" required readonly></vue-autonumeric>
                                    </td>
                                    <td hidden>
                                    ...
                                    <td>
                                        <input class="form-control" v-model="detail.unit_name" name= "unit_name[]"
                                            readonly>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <vue-autonumeric :options="autonumericFormat2" name="price[]"
                                            v-model="detail.price" class="form-control" required
                                            readonly></vue-autonumeric>
                                    </td>
                                    <td>
                                        <vue-autonumeric :options="autonumericFormat2" name="discount1p[]"
                                            v-model="detail.discount1p" class="form-control" readonly></vue-autonumeric>
                                    </td>
                                    <td>
                                        <vue-autonumeric :options="autonumericFormat2" name="discount1[]"
                                            v-model="detail.discount1" class="form-control" readonly></vue-autonumeric>
                                    </td>
                                    <td>
                                        <vue-autonumeric :options="autonumericFormat2" name="discount2p[]"
                                            v-model="detail.discount2p" class="form-control" readonly></vue-autonumeric>
                                    </td>
                                    <td>
                                        <vue-autonumeric :options="autonumericFormat2" name="discount2[]"
                                            v-model="detail.discount2" class="form-control" readonly></vue-autonumeric>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <input class="form-control" v-model="detail.division_name"
                                            name= "division_name[]" readonly>
                                    </td>
                                    <td>
                                        <input type="text" v-model="detail.ata" class="form-control" name= "ata[]"
                                            readonly>
                                    </td>
                                    <td>
                                        <input type="text" class="form-control" v-model="detail.ata_week"
                                            name= "ata_week[]" readonly>
                                    </td>
                                    <td hidden>
                                    ...
                                    <td>
                                        <input class="form-control" v-model="detail.warehouse_name"
                                            name= "warehouse_name[]" readonly>
                                    </td>
            ...
            @include('purchase.po.search_modal')
        </form>
    ...
    <script>
        ...
        let app = new Vue({
            ...
            data: {
                ...
                selectedImg: '',
                subTotal: 0,
                serviceTax: '{{ old('ServiceTax') ?? '0' }}',
                pph: '{{ old('PercentagePPH') ?? '0' }}',
                pph22: '{{ old('PPH22') ?? '0' }}',
                pph22Percentage: '{{ old('PercentagePPH22') ?? '0' }}',
                freight: {{ old('Freight') ?? 0 }},
                vatType: '{{ old('VAT') ?? 'N' }}',

                currency: '{{ old('CurrencyID') ?? $currency }}',
                editType: '',
            ...
            methods: {
                ...
                showSearchModal() {
                    ...
                    // klo tabel dah kepanggil sekali harus didestroy dlu biar ga error
                    ...
                    $('#search-result-table').DataTable({
                        ...
                        serverSide: true,
                        ajax: {
                            url: '{{ route('prs.approved_datatable') }}',
                            data: function(d) {
                        ...
                        columns: [{
                                ...
                                render: function(data, type, row) {
                                    return `<input type="checkbox" class="settle-checkbox" data-transaction-no="${row.TransactionNo}">`;
                                }
                            },
                            {
                                data: 'TransactionNo',
                            ...
                            },
                            {
                                ...
                                render: function(data, type, row) {
                                    // Format Transaction Date ke 'DD MMM YYYY'
                            ...
                            },
                            {
                                ...
                                name: 'NeedDate',
                                render: function(data, type, row) {
                                    // Format Need Date ke 'DD MMM YYYY'
                                    return moment(data).format('DD MMM YYYY');
                                },
                                class: 'text-center'
                            },
                ...
                setupDoneButton() {
                    $('#btn-done').on('click', function() {
                        let selectedTransactionNos = [];
                        $('.settle-checkbox:checked').each(function() {
                            selectedTransactionNos.push($(this).data('transaction-no'));
                        });

                        if (selectedTransactionNos.length > 0) {
                            $.ajax({
                                url: '{{ route('prs.get_details') }}',
                                method: 'POST',
                                data: {
                                    _token: '{{ csrf_token() }}',
                                    transaction_nos: selectedTransactionNos
                                },
                                success: function(response) {
                                    $('.settle-checkbox').prop('checked', false);
                                    app.supplierLocked = true;

                                    // if (app.vatType == 'N' || app.vatType == 'E') {
                                    //     $('#VATInclude').prop('disabled', true);
                                    // } else {
                                    //     $('#VATExclude').prop('disabled', true);
                                    //     $('#VATNone').prop('disabled', true);
                                    // }

                                    $('#showSearchModalBtn').prop('disabled', false);
                                    if (response.details && response.details.length > 0) {
                                        response.details.forEach(detail => {
                                            app.addDetailFromPRS(detail);
                                        });
                                        $('#searchModal').modal('hide');
                                    } else {
                                        alert('No details found for the selected PRS.');
                                    }
                                },
                                error: function(xhr) {
                ...
                addDetailFromPRS(prsDetail) {
                    ...
                    this.details.push({
                        id: makeid(10),
                        settleDtID: prsDetail.settleDtID,
                        settleNo: prsDetail.settleNo,
                        part: prsDetail.part ?? null,
                        part_name: prsDetail.part_name,
                        vat: prsDetail.vat ?? 0,
                        qty: prsDetail.qty ?? 1,
                        qtyRemaining: prsDetail.qtyRemaining ?? 1,
                        unitUrl: prsDetail.unitUrl ?? '{{ route('misc.partunit2') }}?id=0',
                        unit: prsDetail.unit ?? null,
                        unit_name: prsDetail.unit_name ?? null,
                        conversion: prsDetail.conversion ?? 1,
                        price: prsDetail.price ?? 0,
                        discount1: prsDetail.discount1 ?? '',
                        discount1p: prsDetail.discount1p ?? '',
                        discount2: prsDetail.discount2 ?? '',
                        discount2p: prsDetail.discount2p ?? '',
                        totalDiscount: prsDetail.totalDiscount ?? 0,
                        totalPrice: prsDetail.totalPrice ?? 0,
                        division: prsDetail.division ?? null,
                        division_name: prsDetail.division_name ?? null,
                        warehouse: prsDetail.warehouse ?? null,
                        warehouse_name: prsDetail.warehouse_name ?? null,
                        ata: prsDetail.ata ?? '{{ date('d/m/Y') }}',
                        ata_week: prsDetail.ata_week ?? date.getWeekNumber(),
                        image: prsDetail.image ?? '',
                        rev: prsDetail.rev ?? rev,
                        transactionNo: prsDetail.transactionNo ?? null,
                        initiated: prsDetail.initiated ?? false
                    });
                }
            ...
            mounted() {
                ...
                $('#po-form').on('change', '.unit', function() {
                    if ($(this).val() != null) {
                ...
                // Init select2 dan update Vue ketika value berubah
                $('#SupplierID').select2().on('change', function() {
                    $('#showSearchModalBtn').prop('disabled', false);
                    app.supplierId = $(this).val();
                });
            }
        });
