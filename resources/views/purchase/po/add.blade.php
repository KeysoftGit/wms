...
@section('content')
    ...
    <div class=" w-100 px-lg-5 py-lg-3 p-3" id="vue-container" style="overflow-x: hidden">
        ...
        <form autocomplete="off" method="post" enctype="multipart/form-data" action="{{ route('po.store') }}" id="po-form">
            @csrf
                        ...
                        <div class="col-lg-6 col-12 pe-lg-5">
                            <div class="row mb-3">
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="text" class="js-flatpickr form-control js-flatpickr-enabled flatpickr-input active" id="DueDate" name="DueDate" placeholder="d/m/Y" value="{{ old('DueDate') ?? '' }}" readonly="readonly" required>
                                </div>
                            </div>
...
{{--                            </div>--}}
                            ...
                            <div class="row mb-3">
                                <div class="col-6">
                                    ...
                                    <input type="text" class="form-control" name="Rate" id="Rate" value="{{ old('Rate') ?? 1 }}">
                                </div>
                                <div class="col-6">
                                    <label class="form-label">Term Of Payment</label>
                                    <input type="text" class="form-control number-input" name="Term" id="Term" value="{{ old('Term') ?? 0 }}">
                                </div>
                            </div>
                    ...
                    <div id="detail-table" class="table-responsive w-100" style="overflow-x: scroll">
                        <table class="table table-bordered nowrap w-100" style="table-layout: fixed; overflow-x: scroll">
                            ...
                            <tr v-for="(detail, index) in details" :key="detail.id">
                                ...
                                <td>
                                    <input type="text" name="ata[]" v-model="detail.ata" class="form-control js-flatpickr" @change="changeATA(index)" :data-index="index" required>
                                </td>
                                <td>
                                    <input type="text" name="ata_week[]" class="form-control" v-model="detail.ata_week" readonly>
                                </td>
                                <td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-2">
                                                <div class="d-flex flex-row align-items-center">
                                                    <vue-autonumeric :options="autonumericFormat2" name="PercentagePPH" data-type="pph" v-model="pph" class="form-control sync-edit" style="width: 50px"></vue-autonumeric>
                                                    <p class="mb-0 ms-1 fs-6">%</p>
                                                </div>
                                            </td>
                                            <td>
                                                <vue-autonumeric :options="getFormat()" class="form-control text-end sync-edit" data-type="serviceTax" name="ServiceTax" v-model="serviceTax"></vue-autonumeric>
                                            </td>
                                        </tr>
{{--                                        <tr>--}}
