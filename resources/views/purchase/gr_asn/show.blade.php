            ...
            <div class="block-content pb-3">
                ...
                <div class="row">
                    <div class="col-lg-6 col-12 pe-lg-5">
                        ...
                        @if($gr->ASNNumber)
                            <div class="mb-3">
                                <label class="form-label">Advance Shipping Notice</label>
                                <input type="text" class="form-control" value="{{ $gr->ASNNumber }}" readonly>
                            </div>
                        @endif
                    </div>
                    ...
                    <table class="table table-bordered w-100" style="table-layout: fixed; overflow-x: scroll">
                        ...
                        <tbody>
                            <tr v-for="detail in details" v-if="detail.QtyReceive > 0">
                                ...
                                <td>
                                    <vue-autonumeric class="form-control" :options="autonumericFormat2" type="text"
                                        name="Qty2[]" v-model="detail.Qty2" readonly></vue-autonumeric>
                                </td>
                                <td>
    ...
    <script>
        let app = new Vue({
            ...
            data: {
                ...
                isLoading: false,
                po: '{{ $gr->ASNNumber ?: $gr->qc->PONumber }}',
            ...
            methods: {
                ...
                getDetail() {
                    ...
                    let app = this;
                    $.ajax({
                        url: '{{ $gr->ASNNumber ? route('gr.asn.detail') : route('gr.po.detail') }}',
                        type: 'GET',
                        data: {
                            id: app.po,
