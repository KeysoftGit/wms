...
@section('content')
    ...
    <div class="px-lg-5 py-lg-3 p-3" id="vue-container">
        <form autocomplete="off" method="post" enctype="multipart/form-data" action="{{ route('gr.asn.update') }}" id="po-form">
            @csrf
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-12 pe-lg-5">
                            ...
                            <div class="mb-3" id="loading-po">
                                ...
                                <select class="form-select" disabled>
                                    <option id="loading-text">Loading {{ $useAsn ? 'Advance Shipping Notices' : 'Purchase Orders' }}.....</option>
                                </select>
                            </div>
                            <div class="mb-3" id="po-container">
                                <label class="form-label">{{ $useAsn ? 'Advance Shipping Notice' : 'Purchase Order' }} <span class="text-danger">*</span></label>
                                <select class="form-select form-select2" name="{{ $useAsn ? 'ASNNumber' : 'PONumber' }}" id="PONumber" required>
                                    <option value="">-</option>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="d-flex flex-row justify-content-between align-items-center mb-3">
                        ...
                        <div class="d-flex flex-row">
                            <button type="button" class="btn btn-primary ms-1" @click="openDetailModal"
                                ...
                                Part</button>
                            <button type="button" class="btn btn-secondary ms-1" @click="addRev" v-if="!useAsn"><i
                                    class="fa fa-fw fa-plus me-1"></i>Add Rev</button>
                            <button type="button" class="btn btn-secondary ms-1" @click="removeRev" v-if="!useAsn"><i
                        ...
                        <table class="table table-bordered w-100" style="table-layout: fixed; overflow-x: scroll">
                            <thead>
                                <tr>
                                    ...
                                    <th v-for="(n, i) in revCount" style="width: 250px;" v-if="!useAsn">
                                        <span
                            ...
                            <tbody>
                                <tr v-if="details.length == 0">
                                    <td :colspan="11 + (!useAsn ? revCount : 0)" class="text-center text-muted py-4">
                                ...
                                <tr v-for="(detail, index) in details">
                                    ...
                                    <td v-for="(n, i) in revCount" v-if="!useAsn">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row" v-if="selectedPoDetail">
                            ...
                            <div class="col-lg-6 col-12 mb-3" v-for="(n, i) in revCount" v-if="!useAsn">
    ...
    <script>
        let app = new Vue({
            ...
            data: {
                ...
                sourceNumber: '{{ old($useAsn ? 'ASNNumber' : 'PONumber') ?? ($useAsn ? $gr->ASNNumber : $gr->qc->PONumber) }}',
                sourcePONumber: '{{ old('PONumber') ?? $gr->qc->PONumber }}',
                currency: '',
                currencyName: '',
                poDetails: [],
                details: [],
        ...
        // LOAD PO
        loadPOOptions('{{ old('WarehouseID') ?? $gr->WarehouseID }}', '{{ old($useAsn ? 'ASNNumber' : 'PONumber') ?? ($useAsn ? $gr->ASNNumber : $gr->qc->PONumber) }}');
    </script>
@endsection
