...
@section('titles')
    <title>Keysoft NLA WMS - Add Direct Purchase</title>
@endsection
...
@section('content')
    ...
    <div class=" w-100 px-lg-5 py-lg-3 p-3" id="vue-container" style="overflow-x: hidden">
        ...
        <form autocomplete="off" method="post" enctype="multipart/form-data" action="{{ route('dp.store') }}" id="po-form">
            @csrf
...
{{--                            </div>--}}
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="text" class="form-control number-input" name="FiscalRate" id="FiscalRate" value="{{ old('FiscalRate') ?? 1 }}">
                                </div>
                            </div>
...
@section('scripts')
    ...
    <script>
        ...
        $('#detail-table').on('scroll', function (){
           console.log('test');
        });
        ...
        let app = new Vue({
            ...
            data: {
                ...
                pph: '{{ old('PercentageServiceTax') ?? '0' }}',
