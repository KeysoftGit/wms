...
@section('titles')
    <title>Keysoft NLA WMS - Add Purchase Invoice</title>
@endsection
...
@section('content')
    ...
    <div class=" w-100 px-lg-5 py-lg-3 p-3" id="vue-container" style="overflow-x: hidden">
        ...
        <form autocomplete="off" method="post" enctype="multipart/form-data" action="{{ route('pi.store') }}" id="pi-form">
            @csrf
                        ...
                        <div class="col-lg-6 col-12 ps-lg-5">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="text" class="form-control" name="FiscalRate" id="FiscalRate" value="{{ old('FiscalRate') ?? 1 }}">
                                </div>
                            </div>
                ...
                <div class="block-content">
                    ...
                    <div class="table-responsive w-100">
                        <table class="table table-bordered w-100">
                            ...
                            <tr>
                                <td>
                                    <select2 url="{{route('pi.po')}}" v-model="dpInv" :prevalue="dpInv" id="DPReff" class="form-select" name="DPReff"
                                ...
                                <td>
                                    <vue-autonumeric :options="getFormat()" type="text" name="DownPaymentPercent" class="form-control text-end sync-edit" v-model="dpP" data-type="dpP" required></vue-autonumeric>
                                </td>
                                <td>
                        ...
                        <div class="row">
                            <div class="col-auto d-flex flex-row align-items-center">
                                ...
                                <div style="width: 300px;">
                                    <select2 url="{{route('pi.gr')}}" id="PickGR" class="form-select"
    ...
    <script>
        let app = new Vue({
            ...
            data: {
                ...
                serviceP: '{{ old('PercentageServiceTax') ?? '0' }}',
                pph22: '{{ old('PPH22') ?? '0' }}',
                pph22Percentage: '{{ old('PercentagePPH22') ?? '0' }}',
                freight: {{ old('Freight') ?? 0 }},
                invType: '{{ old('InvoiceType') ?? 'PROCEREMENT' }}',
                vatType: '{{ old('VAT') ?? 'N' }}',
                vatP: '{{ old('VATP') ?? 11 }}',
                pickedVat: 'N',
                vatValue: 0,
            ...
            methods: {
                ...
                getPIUrl(){
                    return '{{ route('pi.pi') }}' + '?supplier=' + this.supplierID
                },
