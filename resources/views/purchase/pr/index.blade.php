...
@section('titles')
    <title>Keysoft NLA WMS - Purchase Return</title>
@endsection
        ...
        <div class="d-flex flex-column flex-md-row justify-content-md-between align-items-md-center py-2 text-md-start">
            <div class="flex-grow-1 mb-1 mb-md-0">
                ...
                <div class="row justify-content-between align-items-end mb-3">
                    ...
                    @if(auth()->user()->hasAnyPermission(['admin', 'pr.add']))
                        <div class="col-auto">
                            <a class="btn btn-primary" href="{{ route('pr.add') }}"><i class="fa fa-fw fa-plus"></i> Add</a>
                        </div>
                    @endif
                </div>
                        ...
                        <div class="table-responsive w-100">
                            <table class="table table-bordered table-striped table-vcenter table-fixed" id="datatable">
                                ...
                                <tr>
                                    ...
                                    <th class="text-center">Receiving Number</th>
        ...
        $(function() {
            ...
            $('#datatable').DataTable({
                ...
                columns: [
                    ...
                    { data: 'BasedOnGoodsReceiving', name: 'BasedOnGoodsReceiving', class: 'text-center',
                        render: function ( data, type, row ){
                            if(row.BasedOnGoodsReceiving == 1){
                                return 'GOODS RECEIVING';
                            }
                            else if(row.BasedOnDirectPurchase == 1){
                    ...
                    { data: 'ReceivingNumber', name: 'ReceivingNumber', class: 'text-center'},
                        ...
                        $.ajax({
                            ...
                            if (data.status == 'success'){
                                ...
                                One.helpers('jq-notify', {
                                    ...
                                    message: 'Purchase Return successfully deleted!',
                                });
                            }
                            else {
                                Swal.fire({
