...
@section('titles')
    <title>Keysoft NLA WMS - Edit Purchase Return</title>
@endsection
...
@section('content')
    ...
    <div class="px-lg-5 py-lg-3 p-3" id="vue-container">
        <form autocomplete="off" method="post" enctype="multipart/form-data" action="{{ route('pr.update') }}" id="pr-form">
            @csrf
            ...
            <input type="hidden" name="id" value="{{ $pr->TransactionNo }}">
                ...
                <div class="block-content pb-3">
                    ...
                    <div class="row align-items-center mb-3">
                        <div class="col-lg-2 col-12 mb-lg-0 mb-3">
                            ...
                            <input type="text" name="TransactionNo" id="TransactionNo" class="form-control" value="{{ $pr->TransactionNo }}" readonly>
                        </div>
                        <div class="col-lg-2 col-12 ms-lg-4">
                            <label class="form-label">Transaction Date <span class="text-danger">*</span></label>
                            <input type="text" class="js-flatpickr form-control js-flatpickr-enabled flatpickr-input active" id="TransactionDate" name="TransactionDate" placeholder="d/m/Y" value="{{ old('TransactionDate') ?? date('d/m/Y', strtotime($pr->TransactionDate)) }}" required readonly>
                        </div>
                    </div>
                ...
                <div class="block-content">
                    <div class="row justify-content-between mb-3">
                        <div class="col-lg-4 col-12 mb-lg-0 mb-3">
                            ...
                            <textarea name="Notes" class="form-control" rows="3">{{ old('Notes') ?? $pr->Notes }}</textarea>
                        </div>
    ...
    <script>
        ...
        let app = new Vue({
            ...
            data: {
                ...
                prType: '{{ old('Type') ?? $type }}',
                reff: '{{ old('ReceivingNumber') ?? $pr->ReceivingNumber }}',

                division: '{{ old('DivisionID') ?? $pr->DivisionID }}',
                divisionName: '',
                supplier: '{{ old('SupplierID') ?? $pr->SupplierID }}',
                supplierName: '',
                currency: '{{ old('CurrencyID') ?? $pr->CurrencyID }}',
                currencyName: '',
                rate: {!! old('Rate') ?? $pr->Rate !!},

                vatType: '{{ old('VAT') ?? $pr->VAT }}',
