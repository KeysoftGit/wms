<div class="modal fade" id="closeModal" tabindex="-1" role="dialog" aria-labelledby="modal-block-popout" aria-hidden="true">
    <div class="modal-dialog modal-dialog-popout modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="block block-rounded block-transparent mb-0">
                <form autocomplete="off" method="post" action="{{ route('prs.close') }}">
                    @csrf

                    <input type="hidden" name="id" value="{{ $prs->id }}">

                    <div class="block-header block-header-default">
                        <h3 class="block-title">Close Purchase Request Settle</h3>
