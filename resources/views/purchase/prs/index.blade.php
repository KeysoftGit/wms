...
@section('titles')
    <title>Keysoft NLA WMS - Purchase Request Settle</title>
@endsection
        ...
        $(function() {
            ...
            $('#datatable').DataTable({
                ...
                columns: [
                    ...
                    { data: 'Closed', name: 'Closed', class: 'text-center',
                    ...
                    { data: 'NeedDate', name: 'NeedDate', class: 'text-center',
                        render: function ( data, type, row ){
                            if(data != ''){
                                if ( type === 'display' || type === 'filter' ){
                                    return moment(data).format('DD MMM YYYY');
