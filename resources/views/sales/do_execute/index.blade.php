...
@section('titles')
    <title>Keysoft NLA WMS - Delivery Order Execute</title>
@endsection
    ...
    <script>
        $(function() {
            $('#datatable').DataTable({
                ...
                responsive: false,
                ajax: {
                    url: '{!! route('do_execute.datatable') !!}',
                    data: {
                ...
                columns: [
                    ...
                    { data: 'ReffNumber', name: 'ReffNumber', class: 'text-center'},
