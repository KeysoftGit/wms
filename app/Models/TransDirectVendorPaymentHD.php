...
class TransDirectVendorPaymentHD extends Model
{
    protected $connection= 'sqlsrv';
    protected $table = 'Trans_DirectVendorPaymentHD';
    ...
    {
        return $this->hasMany(TransDirectVendorPaymentDT::class, 'TransactionNo');
    }
}
