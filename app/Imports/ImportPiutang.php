...
class ImportPiutang implements ToModel, WithHeadingRow, WithBatchInserts, WithChunkReading
{
    protected $db;
    protected $UserID;
    ...
    public function model(array $row)
    {
        ...
        return new BukuPiutang([
            'TransactionNo' => "AR/" . \DateTime::createFromFormat('d-m-Y', $row['TransactionDate'])->format('Ym'),
